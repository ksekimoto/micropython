 ...
 */
    #define ETHER_CFG_CH0_PHY_ADDRESS                   (7)     /* Please define the PHY-LSI address in the range of 0-31. */
    #define ETHER_CFG_CH1_PHY_ADDRESS                   (7)     /* Please define the PHY-LSI address in the range of 0-31. */
