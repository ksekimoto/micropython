...
dict_keys = parse_connection("HostName=xxxxxx.azure-devices.net;DeviceId=gr_mango;SharedAccessKey=xxxxxx")
...
sas_token_str = "SharedAccessSignature sr=xxxxxx.azure-devices.net&sig=xxxxxx&se=xxxxxx"
