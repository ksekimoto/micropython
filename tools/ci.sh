...
function ci_rz_gr_mango_build {
    ...
    cd ports/rz
    make ${MAKEOPTS} -C DEBUG=1 BOARD=${BOARD} clean
    make ${MAKEOPTS} -C DEBUG=1 BOARD=${BOARD} MICROPY_PY_ESP8266=1 MICROPY_PY_LWIP=1 MICROPY_SSL_MBEDTLS=1 MICROPY_PY_USSL=1
}
