...
/* Dummy*/
void __attribute__ ((weak)) INT_Dummy(void){/* brk(); */}
...
/* SCI12 SCIX0*/
void __attribute__ ((weak)) INT_Excep_SCI12_SCIX0(void){ }

/* SCI12 SCIX1*/
void __attribute__ ((weak)) INT_Excep_SCI12_SCIX1(void){ }

/* SCI12 SCIX2*/
void __attribute__ ((weak)) INT_Excep_SCI12_SCIX2(void){ }

/* SCI12 SCIX3*/
void __attribute__ ((weak)) INT_Excep_SCI12_SCIX3(void){ }
...
/* DEU DEU0*/
void __attribute__ ((weak)) INT_Excep_DEU_DEU0(void){ }

/* DEU DEU1*/
void __attribute__ ((weak)) INT_Excep_DEU_DEU1(void){ }

/* PDC PCDFI*/
void __attribute__ ((weak)) INT_Excep_PDC_PCDFI(void){ }

/* PDC PCFEI*/
void __attribute__ ((weak)) INT_Excep_PDC_PCFEI(void){ }

/* PDC PCERI*/
void __attribute__ ((weak)) INT_Excep_PDC_PCERI(void){ }
