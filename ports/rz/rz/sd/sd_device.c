...
******************************************************************************/
#if defined(__GNUC__)
static uint32_t s_sd_work[2][SD_SIZE_OF_INIT / sizeof(uint32_t)]__attribute__ ((section("NC_BSS"), aligned(32)));
static uint32_t s_sd_rw_buff[2][SD_PRV_RW_BUFF_SIZE / sizeof(uint32_t)] __attribute__ ((section("NC_BSS"), aligned(32)));
