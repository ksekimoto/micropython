...
#define MBED_CONF_LWIP_DEFAULT_THREAD_STACKSIZE                               640                                                                                              // set by library:lwip[RZ_A2_EMAC]
...
#define MBED_CONF_LWIP_MEMP_NUM_TCP_SEG                                       32                                                                                               // set by library:lwip[RZ_A2_EMAC]
#define MBED_CONF_LWIP_MEM_SIZE                                               25600                                                                                            // set by library:lwip[RZ_A2_EMAC]
#define MBED_CONF_LWIP_PBUF_POOL_SIZE                                         16                                                                                               // set by library:lwip[RZ_A2_EMAC]
#define MBED_CONF_LWIP_PPP_THREAD_STACKSIZE                                   896                                                                                              // set by library:lwip[RZ_A2_EMAC]
#define MBED_CONF_LWIP_SOCKET_MAX                                             4                                                                                                // set by library:lwip
#define MBED_CONF_LWIP_TCPIP_THREAD_STACKSIZE                                 1328                                                                                             // set by library:lwip[RZ_A2_EMAC]
#define MBED_CONF_LWIP_TCP_ENABLED                                            1                                                                                                // set by library:lwip
#define MBED_CONF_LWIP_TCP_MAXRTX                                             6                                                                                                // set by library:lwip
#define MBED_CONF_LWIP_TCP_MSS                                                1460                                                                                             // set by library:lwip[RZ_A2_EMAC]
#define MBED_CONF_LWIP_TCP_SERVER_MAX                                         4                                                                                                // set by library:lwip
#define MBED_CONF_LWIP_TCP_SND_BUF                                            (8 * TCP_MSS)                                                                                    // set by library:lwip[RZ_A2_EMAC]
#define MBED_CONF_LWIP_TCP_SOCKET_MAX                                         4                                                                                                // set by library:lwip
#define MBED_CONF_LWIP_TCP_WND                                                (TCP_MSS * 8)                                                                                    // set by library:lwip[RZ_A2_EMAC]
