...
void __attribute__ ((weak)) INT_Excep_SuperVisorInst(void)
{/* brk(); */
}

// Exception(Access Instruction)
void __attribute__ ((weak)) INT_Excep_AccessInst(void)
{/* brk(); */
}

// Exception(Undefined Instruction)
void __attribute__ ((weak)) INT_Excep_UndefinedInst(void)
{/* brk(); */
}

// Exception(Floating Point)
void __attribute__ ((weak)) INT_Excep_FloatingPoint(void)
{/* brk(); */
}

// NMI
void __attribute__ ((weak)) NonMaskableInterrupt(void)
{/* brk(); */
}

// Dummy
void __attribute__ ((weak)) Dummy(void)
{/* brk(); */
}

// BRK
void __attribute__ ((weak)) INT_Excep_BRK(void)
{ /* wait(); */
}
